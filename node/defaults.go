...
const (
	...
	DefaultHTTPPort = 55557       // Default TCP port for the HTTP RPC server
...
func DefaultDataDir() string {
	...
	if home != "" {
		if runtime.GOOS == "darwin" {
			return filepath.Join(home /*"Library", "Blockchain"*/, "lovdata")
		} else if runtime.GOOS == "windows" {
			return filepath.Join(home /*"AppData", "Roaming", "Blockchain"*/, "lovdata")
		} else {
			return filepath.Join(home /*".blockchain"*/, "lovdata")
		}
	}
...
func homeDir() string {
	// change datadir => current directory
