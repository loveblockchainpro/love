...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "lov.ipc", false, filepath.Join(os.TempDir(), "lov.ipc")},
		{"data", "lov.ipc", false, "data/lov.ipc"},
		{"data", "./lov.ipc", false, "./lov.ipc"},
		{"data", "/lov.ipc", false, "/lov.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "lov.ipc", true, `\\.\pipe\lov.ipc`},
		{"data", "lov.ipc", true, `\\.\pipe\lov.ipc`},
		{"data", `\\.\pipe\lov.ipc`, true, `\\.\pipe\lov.ipc`},
	}
