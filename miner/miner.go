...
// Package miner implements Blockchain block creation and mining.
package miner
...
func (self *Miner) SetLoverbase(addr common.Address) {
	self.coinbase = addr
	self.worker.setLoverbase(addr)
}
