Name "net ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
...
# Install net binary
Section "Geth" GNET_IDX
  SetOutPath $INSTDIR
  file {{.Geth}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\net.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\net.exe" "attach" "" ""
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe" "" "" ""

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Geth incoming peers (TCP:44446)"
  SimpleFC::AdvRemoveRule "Geth outgoing peers (TCP:44446)"
  SimpleFC::AdvRemoveRule "Geth UDP discovery (UDP:44446)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:44446)" ""  6 1 1 2147483647 1 "$INSTDIR\net.exe" "" "" "Blockchain" 44446 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:44446)" ""  6 2 1 2147483647 1 "$INSTDIR\net.exe" "" "" "Blockchain" "" 44446 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:44446)" "" 17 2 1 2147483647 1 "$INSTDIR\net.exe" "" "" "Blockchain" "" 44446 "" ""

  # Set default IPC endpoint (https://github.com/blockchain/EIPs/issues/147)
  ${EnvVarUpdate} $0 "BLOCKCHAIN_SOCKET" "R" "HKLM" "\\.\pipe\net.ipc"
  ${EnvVarUpdate} $0 "BLOCKCHAIN_SOCKET" "A" "HKLM" "\\.\pipe\net.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GNET_IDX}
    SectionGetSize ${GNET_IDX} $0
