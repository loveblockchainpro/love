...
func SetupGenesisBlock(db ethdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
    ...
    "difficulty": "0x4000",
    "alloc": {"0x446914b0bd38e6cc61a634ba177d78ac8d5e20e9":{"balance":"236000000000000000000000000"}},
...
// DeveloperGenesisBlock returns the 'lov --dev' genesis block. Note, this must
// be seeded with the
