...
var (
	...
	SwarmStorePath = cli.StringFlag{
		Name:   "store.path",
		Usage:  "Path to leveldb chunk DB (default <$GNET_ENV_DIR>/swarm/bzz-<$BZZ_KEY>/chunks)",
...
// This init function sets defaults so cmd/swarm can run alongside net.
func init() {
...
var app = utils.NewApp(gitCommit, "Blockchain Swarm")
...
func bzzd(ctx *cli.Context) error {
	...
	//net only supports --datadir via command line
	//in order to be consistent within swarm, if we pass --datadir via environment variable
	//or via config file, we get the same directory for net and swarm
