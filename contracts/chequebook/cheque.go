...
// issuing, receiving, verifying cheques in lover; (auto)cashing cheques in lover
// as well as (auto)depositing lover to the chequebook contract.
package chequebook
...
// * depositing lover to the chequebook
// * watching incoming lover
