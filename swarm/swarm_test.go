...
func TestParseEnsAPIAddress(t *testing.T) {
	for _, x := range []struct {
	...
	}{
		{
			...
			value:       "/data/testnet/lov.ipc",
			endpoint:    "/data/testnet/lov.ipc",
		},
		{
		...
		},
		{
			...
			value:       "test:/data/testnet/lov.ipc",
			endpoint:    "/data/testnet/lov.ipc",
			tld:         "test",
		},
		{
		...
		},
		{
			...
			value:       "314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/lov.ipc",
			endpoint:    "/data/testnet/lov.ipc",
		...
		},
		{
			...
			value:       "test:314159265dD8dbb310642f98f50C066173C1259b@/data/testnet/lov.ipc",
			endpoint:    "/data/testnet/lov.ipc",
			addr:        common.HexToAddress("314159265dD8dbb310642f98f50C066173C1259b"),
			tld:         "test",
		},
...
// https://github.com/netersphere/go-blockchain/issues/639
