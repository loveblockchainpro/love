...
import (
	...
	lovmetrics "github.com/blockchain/go-blockchain/metrics"
...
func Setup(ctx *cli.Context) {
	if lovmetrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(lovmetrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
