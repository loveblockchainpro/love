...
var (
	MainnetGenesisHash = common.HexToHash("0x921d0651775e6a4e729c2c056aba8bd143c96f2fce11623aa0772a79bb544d3c")	//NETCHAIN
...
// GetBlockRewards adjust block reward
func (c *ChainConfig) GetBlockRewards(blockReward, num *big.Int) *big.Int {

	if isForked(big.NewInt(10000000), num) {
		blockReward.Mul(blockReward, big.NewInt(50))
	} else if isForked(big.NewInt(8000000), num) {
		blockReward.Mul(blockReward, big.NewInt(40))
	} else if isForked(big.NewInt(6000000), num) {
		blockReward.Mul(blockReward, big.NewInt(30))
	} else if isForked(big.NewInt(4000000), num) {
		blockReward.Mul(blockReward, big.NewInt(20))
	} else if isForked(big.NewInt(2000000), num) {
		blockReward.Mul(blockReward, big.NewInt(10))
	}
	return blockReward
}
