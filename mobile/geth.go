...
// NodeConfig represents the collection of configuration values to fine tune the Lov
...
// Node represents a Lov Blockchain node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Lov node.
